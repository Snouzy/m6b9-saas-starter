...
export const LogoSvg = ({ size = 32, ...props }: LogoSvgProps) => {
  return (
    <svg fill="none" height={size} viewBox="0 0 120 120" width={size} xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        clipRule="evenodd"
        ...
        fillRule="evenodd"
      />
      <path clipRule="evenodd" d="M73.7225 78.6076H46.2771L59.9998 9.99994L73.7225 78.6076Z" fill="currentColor" fillRule="evenodd" />
      <path
        clipRule="evenodd"
