...
export const PainSection = () => {
  return (
    <SectionLayout className=" flex flex-col items-center justify-center gap-4" size="base" variant="card">
      <div className="flex w-full flex-col items-center gap-3 lg:gap-4 xl:gap-6">
        ...
        <Typography variant="large">But I loose my time going and publishing each days</Typography>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 rounded bg-green-500/30 p-4">
            <Typography className="text-green-500" variant="h3">
