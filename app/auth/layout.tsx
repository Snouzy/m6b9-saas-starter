  ...
  return (
    <>
      ...
      <main className="relative flex grow">
        <div aria-hidden="true" className="pointer-events-none absolute bottom-0 left-0 -translate-x-1/3">
        ...
        <>
          ...
          <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl lg:block">
            ...
            >
              <Image alt="Auth bg" className="max-w-none" height={1684} src={AuthBg} width={1285} />
            </div>
            {/* Illustration */}
